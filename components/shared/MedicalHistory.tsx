...
const MedicalHistory = () => {
  return (
    <div className="ring-1 mt-5  ring-gray-400">
      <div className="w-full h-[40px] flex bg-[#007C85] rounded-sm items-center justify-center p-3 mb-5"></div>
      ...
      <div className="ring-1 ring-gray-400 rounded-md">
        <Table>
          <TableHeader>
            <TableRow>
